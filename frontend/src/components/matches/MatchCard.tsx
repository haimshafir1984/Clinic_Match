      ...
      <Card className="cursor-pointer p-4 transition-colors hover:bg-accent/50">
        <div className="flex items-center gap-4">
          <Avatar className="h-14 w-14">
            ...
            <AvatarFallback className="bg-primary/10"><RoleIcon className="h-6 w-6 text-primary" /></AvatarFallback>
          </Avatar>
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10"><MessageCircle className="h-5 w-5 text-primary" /></div>
        </div>
      </Card>
    </Link>
  );
